...
- (void) cancel: (id) sender {
  	...
  	if ([_delegate respondsToSelector: @selector(authControllerDidCancelled)]) 
        [_delegate performSelector:@selector(authControllerDidCancelled)];
...
- (void) loadView {
    ...
    [_navBar setBarStyle:UIBarStyleBlack];
...
//    [self changeBackgroundOfNavigationBar:_navBar];
