...
{
    [super viewDidLoad];
    [model addObserver:self forKeyPath:@"wordsStore" options:NSKeyValueObservingOptionNew context:nil];
...
{
    if ([keyPath isEqualToString:@"wordsStore"]) {
        [myTable reloadData];
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [NSString stringWithFormat:@"add to wordbook"];
    // Configure the cell...
